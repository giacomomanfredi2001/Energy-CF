function err = MAPE(p, F_params, prices, T1, T2, m, n, X_t, Y_t)
...
%
% Returns:
% err       The mean absolute percentage error between model-predicted and 
%           observed prices

% Calculate the MAPE by iterating over all Future contracts
err = mean(abs(arrayfun(@(i) ...
